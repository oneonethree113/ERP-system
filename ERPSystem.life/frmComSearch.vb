Public Class frmComSearch
    ...
    Public flg_MSR00035 As Boolean = False
...
#End Region
    ...
    Public Sub show_MSR00035(ByVal btn As Button)
    ...
    Private Sub frmComSearch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Select Case callFmCriteria
            ...
            Case "txt_S_PV"
                ...
                Me.btcSearch.TabPages(2).Enabled = False
            Case "txt_S_FA"
                Me.lblSearchingCriteria.Text = "Searching Criteria : Factory Audit"
                Me.btcSearch.TabPages(0).Enabled = True
                Me.btcSearch.TabPages(1).Enabled = True
                rangeMode = "COMBO"
                Me.btcSearch.TabPages(2).Enabled = False
            Case "txt_S_SalTem"
                ...
                Me.btcSearch.TabPages(2).Enabled = False
            Case "txt_S_SalDiv"
                Me.lblSearchingCriteria.Text = "Searching Criteria : Sales Division"
                Me.btcSearch.TabPages(0).Enabled = True
                Me.btcSearch.TabPages(1).Enabled = True
                rangeMode = "COMBO"
                Me.btcSearch.TabPages(2).Enabled = False
            ...
            Case "txt_S_TONo"
                Me.lblSearchingCriteria.Text = "Searching Criteria : TO Number"
                Me.btcSearch.TabPages(0).Enabled = False
                Me.btcSearch.TabPages(1).Enabled = True
                rangeMode = "TEXT"
                Me.btcSearch.TabPages(2).Enabled = False
            Case "txt_S_PriceTerm"
                Me.lblSearchingCriteria.Text = "Searching Criteria : Price Term"
                Me.btcSearch.TabPages(0).Enabled = True
                Me.btcSearch.TabPages(1).Enabled = True
                rangeMode = "COMBO"
                Me.btcSearch.TabPages(2).Enabled = False
            Case "txt_S_QutNo"
                Me.lblSearchingCriteria.Text = "Searching Criteria : Qut No"
                Me.btcSearch.TabPages(0).Enabled = False
                Me.btcSearch.TabPages(1).Enabled = True
                rangeMode = "TEXT"
                Me.btcSearch.TabPages(2).Enabled = False
            Case "txt_S_QCReqNo"
                Me.lblSearchingCriteria.Text = "Searching Criteria : QC Request Number"
                Me.btcSearch.TabPages(0).Enabled = False
                Me.btcSearch.TabPages(1).Enabled = True
                rangeMode = "TEXT"
                Me.btcSearch.TabPages(2).Enabled = False
            Case "txt_S_QCRptNo"
                Me.lblSearchingCriteria.Text = "Searching Criteria : QC Report Number"
                Me.btcSearch.TabPages(0).Enabled = False
                Me.btcSearch.TabPages(1).Enabled = True
                rangeMode = "TEXT"
                Me.btcSearch.TabPages(2).Enabled = False

                ''Michael chiu 20170324
            Case "txt_S_ContainNo"
                Me.lblSearchingCriteria.Text = "Searching Criteria : Container No"
                Me.btcSearch.TabPages(0).Enabled = False
                Me.btcSearch.TabPages(1).Enabled = True
                rangeMode = "TEXT"
                Me.btcSearch.TabPages(2).Enabled = False
    ...
    Private Sub fillinBox()
        Select Case callFmCriteria
            ...
            Case "txt_S_SalDiv"
                gspStr = "sp_list_CUBASINF_CLR00004 '','" & gsUsrID & "'"
            Case "txt_S_VdrCde"
                gspStr = "sp_list_VNBASINF ''"
            Case "txt_S_PriceTerm"
    ...
    Private Sub fillselection(ByVal mode As String)
        ...
        If rs_fillinBox.Tables("RESULT") Is Nothing Then
            Exit Sub
        End If
        ...
        If rs_fillinBox.Tables("RESULT").Rows.Count > 0 Then
            For i = 0 To rs_fillinBox.Tables("RESULT").Rows.Count - 1
                ...
                Select Case callFmCriteria
                    ...
                    Case "txt_S_SalDiv"
                        strList = rs_fillinBox.Tables("RESULT").Rows(i).Item("cbi_saldiv") & " - Sales Division " & rs_fillinBox.Tables("RESULT").Rows(i).Item("cbi_saldiv")
                    Case "txt_S_VdrCde"
                        strList = rs_fillinBox.Tables("RESULT").Rows(i).Item("vbi_venno") & " - " & rs_fillinBox.Tables("RESULT").Rows(i).Item("vbi_vensna")
                    Case "txt_S_PriceTerm"
                        strList = rs_fillinBox.Tables("RESULT").Rows(i).Item("ysi_cde")
                    Case "txt_S_SCNo"
                        strList = ""
                    Case "txt_S_ContainNo"
                        strList = ""
    ...
    Private Sub cmdOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOK.Click
        ...
        Select Case callFmCriteria
            ...
            Case "txt_S_PV"
                ...
                End Select
            Case "txt_S_FA"
                Dim ctn() As Control = frmS.Controls.Find("txt_S_FA", True)
                ctn(0).Text = tmpStr
            Case "txt_S_SalTem"
                Select Case callFmForm
                    Case "POM00003"
            ...
            Case "txt_S_TONo"
                Select Case callFmForm
                    Case Else
                        Dim ctn() As Control = frmS.Controls.Find("txt_S_TONo", True)
                        ctn(0).Text = tmpStr
                End Select
            Case "txt_S_PriceTerm"
                Select Case callFmForm
                    Case Else
                        Dim ctn() As Control = frmS.Controls.Find("txt_S_PriceTerm", True)
                        ctn(0).Text = tmpStr
                End Select
            Case "txt_S_QutNo"
                Select Case callFmForm
                    Case Else
                        Dim ctn() As Control = frmS.Controls.Find("txt_S_QutNo", True)
                        ctn(0).Text = tmpStr
                End Select
            Case "txt_S_QCReqNo"
                Dim ctn() As Control = frmS.Controls.Find("txt_S_QCReqNo", True)
                ctn(0).Text = tmpStr
            Case "txt_S_QCRptNo"
                Dim ctn() As Control = frmS.Controls.Find("txt_S_QCRptNo", True)
                ctn(0).Text = tmpStr
            Case "txt_S_ContainNo"
                Dim ctn() As Control = frmS.Controls.Find("txt_S_ContainNo", True)
                ctn(0).Text = tmpStr
        End Select
