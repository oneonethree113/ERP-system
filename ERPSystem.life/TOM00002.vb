Public Class TOM00002
    ...
    Public Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        Else
            ...
            Else
                ...
                Dim drv As DataRowView = rs_QUOTNDTL.Tables("RESULT").DefaultView(0)
                StatusBar.Items("lblRight").Text = Format(drv.Item("quh_credat"), "MM/dd/yyyy") & " " & Format(drv.Item("quh_upddat"), "MM/dd/yyyy") & " " & drv.Item("quh_updusr")
    ...
    Private Sub Display_Detail(ByVal grd As DataGridView)
        ...
        With grd
            ...
            .Columns(5).HeaderCell.Value = "Vendor No."
            ...
            Else
                ...
                For i As Integer = 0 To rs_QUOTNDTL_tmp_sorttable.Rows.Count - 1
                    ...
                    If rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qud_toqty") >= 0 And rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("gen") = "Y" Then
                        ...
                        Dim tod_markup = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_mu")
                        Dim tod_mrkprc = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_muprc")
                        Dim tod_mumin = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_mumin")
                        Dim tod_muminprc = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_muminprc")
                        Dim tod_pckcst = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_pkgper")
                        Dim tod_commsn = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_comper")
                        Dim tod_itmcom = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_icmper")
                        Dim tod_stdprc = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_cus1sp")
                        Dim tod_adjprc = rs_QUOTNDTL_tmp_sorttable.Rows(i).Item("qpe_cus1dp")
