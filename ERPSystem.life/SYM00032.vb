Public Class SYM00032
    ...
    Private Sub SYM00032_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            gspStr = "sp_select_SYCUREX_ACC '" & gsCompany & "','','N'"
            rtnLong = execute_SQLStatement(gspStr, rs_curex, rtnStr)
            If rtnLong <> RC_SUCCESS Then
                MsgBox("Error on loading SYM00032 sp_select_SYCUREX_ACC : " & rtnStr)
            Else
    ...
    Private Sub FillComboEffDate()
        ...
        Try
            ...
            gspStr = "sp_select_SYCUREX_ACC '" & gsCompany & "','','Y'"
    ...
    Private Sub mmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mmdSave.Click
        ...
        Try
            ...
            Else
                ...
                For Each dr As DataRow In rs_curex.Tables("RESULT").Rows
                    ...
                    If dr.RowState = DataRowState.Modified Then
                        ...
                        If Not dr.Item("yce_status") = "Y" Then
                            gspStr = "sp_update_SYCUREX_ACC '" & gsCompany & "','" & _
                                        ...
                                        dr.Item("yce_expdat").ToString.Replace("'", "''").Trim & "','" & _
                    ...
                    ElseIf dr.RowState = DataRowState.Added And Not dr.Item("yce_status") = "Y" Then
                        ...
                        If dr.Item("yce_credat").ToString.Trim = "" Then
                            gspStr = "sp_insert_SYCUREX_ACC '" & gsCompany & "','" & _
                                        dr.Item("yce_frmcur").ToString.Replace("'", "''").Trim & "','" & _
                                        dr.Item("yce_tocur").ToString.Replace("'", "''").Trim & "'," & _
                                        dr.Item("yce_buyrat").ToString.Replace("'", "''").Trim & "," & _
                                        dr.Item("yce_selrat").ToString.Replace("'", "''").Trim & ",'" & _
                                        dr.Item("yce_effdat").ToString.Replace("'", "''").Trim & "','12/31/1900 23:59:59','" & _
                                        dr.Item("yce_iseff").ToString.Replace("'", "''").Trim & "','" & _
                                        dr.Item("yce_display").ToString.Replace("'", "''").Trim & "','" & _
                                        gsUsrID & "'"
                        End If
                    ...
                    If gspStr <> "" Then
                        ...
                        If rtnLong <> RC_SUCCESS Then
                            MsgBox("Error on loading SYM00032 sp_update_SYCUREX_ACC : " & rtnStr)
                            flgErr = True
                            Exit For
                        End If
                        gspStr = ""
                ...
                Dim gspStrTemp As String
                gspStrTemp = "sp_update_SYCUREX_ACC_expdat '" & CType(txtEffDat.Text, Date) & "'"
                If gspStrTemp <> "" Then
                    rtnLong = execute_SQLStatement(gspStrTemp, rs, rtnStr)
                    If rtnLong <> RC_SUCCESS Then
                        MsgBox("Error on loading SYM00032 sp_update_SYCUREX_ACC_expdat : " & rtnStr)
                        flgErr = True
                    End If
                    gspStrTemp = ""
                End If
    ...
    Private Sub SYM00032_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim YNC As Integer
        Dim flgMod As Boolean = False
