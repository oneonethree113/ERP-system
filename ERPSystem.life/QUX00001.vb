            ...
            Else
                ...
                For i As Integer = 0 To rs_QUOTNDTL_TO_tmp_sorttable.Rows.Count - 1
                    ...
                    If rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qud_toqty") >= 0 And rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("gen") = "Y" Then
                        ...
                        Dim tod_markup = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_mu")
                        Dim tod_mrkprc = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_muprc")
                        Dim tod_mumin = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_mumin")
                        Dim tod_muminprc = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_muminprc")
                        Dim tod_pckcst = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_pkgper")
                        Dim tod_commsn = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_comper")
                        Dim tod_itmcom = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_icmper")
                        Dim tod_stdprc = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_cus1sp")
                        Dim tod_adjprc = rs_QUOTNDTL_TO_tmp_sorttable.Rows(i).Item("qpe_cus1dp")
...
tod_adjprc & "','" & _
    ...
    Sub map_common()
        ...
        Dim temp_value_AB, temp_value_AI, temp_value_AY, temp_value_AP, temp_value_BK As String
        ...
        With xlsApp
            While (.Range("L" + (i + 3).ToString).Value <> Nothing)
                ...
                If .Range("AV" + (i + 3).ToString).Value Is Nothing Then
                    temp_pckcst = "0"
                Else
                    temp_pckcst = .Range("AV" + (i + 3).ToString).Value.ToString.Trim
                ...
                If IsNumeric(.Range("AB" + (i + 3).ToString).Value) = True Then
                    temp_value_AB = (.Range("AB" + (i + 3).ToString).Value)
                    If IS_contopc = True Then
                        temp_value_AB = temp_value_AB * temp_value_I
                    End If
                Else
                    temp_value_AB = "0"
                End If
                ...
                If IsNumeric(.Range("AI" + (i + 3).ToString).Value) = True Then
                    temp_value_AI = (.Range("AI" + (i + 3).ToString).Value)
                Else
                    temp_value_AI = "0"
                End If
                ...
                If IsNumeric(.Range("AN" + (i + 3).ToString).Value) = True Then
                    ...
                    If IS_contopc = True Then
                        temp_value_AN = temp_value_AN * temp_value_I
                    End If
                ...
                If IsNumeric(.Range("AO" + (i + 3).ToString).Value) = True Then
                    temp_value_AO = (.Range("AO" + (i + 3).ToString).Value)
                Else
                    temp_value_AO = "0"
                End If


                If IsNumeric(.Range("AY" + (i + 3).ToString).Value) = True Then
                    temp_value_AY = (.Range("AY" + (i + 3).ToString).Value)

                    If IS_contopc = True Then
                        temp_value_AY = temp_value_AY * temp_value_I
                    End If
                ...
                If IsNumeric(.Range("BF" + (i + 3).ToString).Value) = True Then
                ...
                ''Cal
                If IsNumeric(.Range("AP" + (i + 3).ToString).Value) = True Then
                    temp_value_AP = (.Range("AP" + (i + 3).ToString).Value) * cur_rate
                    If IS_contopc = True Then
                        temp_value_AP = temp_value_AP * temp_value_I
                    End If
                ...
                If IsNumeric(.Range("AV" + (i + 3).ToString).Value) = True Then
                    temp_value_AV = (.Range("AV" + (i + 3).ToString).Value) * cur_rate
                    If IS_contopc = True Then
                ...
                If .Range("AX" + (i + 3).ToString).Value Is Nothing Then
                    temp_itmComAmt = "0"
                Else
                    temp_itmComAmt = .Range("AX" + (i + 3).ToString).Value.ToString.Trim
                End If

                If IsNumeric(.Range("AX" + (i + 3).ToString).Value) = True Then
                    temp_value_AX = (.Range("AX" + (i + 3).ToString).Value) * cur_rate
                    If IS_contopc = True Then
                ...
                Else
                    temp_value_AX = "0"
                End If
                temp_itmComAmt = temp_value_AX



                ''Per
                If IsNumeric(.Range("AU" + (i + 3).ToString).Value) = True Then
                    temp_value_AU = (.Range("AU" + (i + 3).ToString).Value) * 100
                Else
                    temp_value_AU = "0"
                End If
                If IsNumeric(.Range("AW" + (i + 3).ToString).Value) = True Then
                    temp_value_AW = (.Range("AW" + (i + 3).ToString).Value) * 100
                Else
                    temp_value_AW = "0"
                End If
                ...
                If IsNumeric(.Range("BD" + (i + 3).ToString).Value) = True Then
                    If Val(.Range("BD" + (i + 3).ToString).Value) > 0 Then
                ...
                If IsNumeric(.Range("BE" + (i + 3).ToString).Value) = True Then
                    temp_value_BE = (.Range("BE" + (i + 3).ToString).Value) * 100
                Else
                    temp_value_BE = "0"
                End If
                ...
                If IsNumeric(.Range("BF" + (i + 3).ToString).Value) = True Then
                    temp_value_BF = (.Range("BF" + (i + 3).ToString).Value) * cur_rate
                    If IS_contopc = True Then
                        temp_value_BF = temp_value_BF * temp_value_I
                    End If
                ...
                If IsDate(.Range("BJ" + (i + 3).ToString).Value) = True Then
                    temp_value_BJ = (.Range("BJ" + (i + 3).ToString).Value)
                Else
                    temp_value_BJ = "01/01/1900"
                End If
                If Year(temp_value_BJ) = 1899 Then
                    temp_value_BJ = "01/01/1900"
                End If


                If IsNumeric(.Range("BK" + (i + 3).ToString).Value) = True Then
                    temp_value_BK = (.Range("BK" + (i + 3).ToString).Value)
                Else
                    temp_value_BK = "0"
                End If
                ...
                gspStr = "sp_insert_QUXLSDTL '" & FileToCopy & _
                  ...
                  "','" & temp_value_AA & _
                  "','" & temp_value_AB & _
                  "','" & Replace(.Range("AC" + (i + 3).ToString).Value, "'", "''") & _
                  "','" & temp_value_AD & _
                  "','" & temp_value_AE & _
                  "','" & temp_value_AF & _
                  "','" & temp_value_AG & _
                  ...
                  "','" & Replace(.Range("AL" + (i + 3).ToString).Value, "'", "''") & _
                  "','" & temp_value_AM & _
                  "','" & temp_value_AN & _
                  "','" & temp_value_AO & _
                  "','" & temp_value_AP & _
                  "','" & .Range("AQ" + (i + 3).ToString).Value & _
                  "','" & .Range("AR" + (i + 3).ToString).Value & _
                  "','" & .Range("AT" + (i + 3).ToString).Value & _
                  "','" & temp_value_AU & _
                  "','" & temp_pckcst & _
                  "','" & temp_value_AW & _
                  "','" & temp_itmComAmt & _
