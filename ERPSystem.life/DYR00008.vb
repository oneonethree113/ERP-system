...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txt_S_SRRvsdatFm As System.Windows.Forms.MaskedTextBox
    Friend WithEvents txt_S_SRRvsdatTo As System.Windows.Forms.MaskedTextBox
    Friend WithEvents txt_S_SRIssdatTo As System.Windows.Forms.MaskedTextBox
    Friend WithEvents txt_S_SRIssdatFm As System.Windows.Forms.MaskedTextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txt_S_SRRvsdatFm = New System.Windows.Forms.MaskedTextBox
        Me.txt_S_SRRvsdatTo = New System.Windows.Forms.MaskedTextBox
        Me.txt_S_SRIssdatTo = New System.Windows.Forms.MaskedTextBox
        Me.txt_S_SRIssdatFm = New System.Windows.Forms.MaskedTextBox
        Me.SuspendLayout()
        '
        'StatusBar1
        '
        ...
        'Label21
        '
        Me.Label21.Location = New System.Drawing.Point(581, 180)
        ...
        'Label22
        '
        Me.Label22.Location = New System.Drawing.Point(297, 180)
        ...
        'Label26
        '
        Me.Label26.Location = New System.Drawing.Point(581, 213)
        ...
        'txt_S_SRRvsdatFm
        '
        Me.txt_S_SRRvsdatFm.Location = New System.Drawing.Point(199, 210)
        Me.txt_S_SRRvsdatFm.Mask = "00/00/0000"
        Me.txt_S_SRRvsdatFm.Name = "txt_S_SRRvsdatFm"
        Me.txt_S_SRRvsdatFm.Size = New System.Drawing.Size(90, 22)
        Me.txt_S_SRRvsdatFm.TabIndex = 197
        '
        'txt_S_SRRvsdatTo
        '
        Me.txt_S_SRRvsdatTo.Location = New System.Drawing.Point(483, 209)
        Me.txt_S_SRRvsdatTo.Mask = "00/00/0000"
        Me.txt_S_SRRvsdatTo.Name = "txt_S_SRRvsdatTo"
        Me.txt_S_SRRvsdatTo.Size = New System.Drawing.Size(88, 22)
        Me.txt_S_SRRvsdatTo.TabIndex = 196
        '
        'txt_S_SRIssdatTo
        '
        Me.txt_S_SRIssdatTo.Location = New System.Drawing.Point(483, 177)
        Me.txt_S_SRIssdatTo.Mask = "00/00/0000"
        Me.txt_S_SRIssdatTo.Name = "txt_S_SRIssdatTo"
        Me.txt_S_SRIssdatTo.Size = New System.Drawing.Size(88, 22)
        Me.txt_S_SRIssdatTo.TabIndex = 195
        '
        'txt_S_SRIssdatFm
        '
        Me.txt_S_SRIssdatFm.Location = New System.Drawing.Point(201, 177)
        Me.txt_S_SRIssdatFm.Mask = "00/00/0000"
        Me.txt_S_SRIssdatFm.Name = "txt_S_SRIssdatFm"
        Me.txt_S_SRIssdatFm.Size = New System.Drawing.Size(88, 22)
        Me.txt_S_SRIssdatFm.TabIndex = 194
        '
        'DYR00008
        '
        ...
        Me.Name = "DYR00008"
        Me.Text = "DYR00008 - Dynamic Report vw_SampleRequest (DYR08)"
...
#End Region
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        If Me.txt_S_SRIssdatFm.Text <> "__/__/____" Then
            If Not IsDate(Me.txt_S_SRIssdatFm.Text) Then
        ...
        If Me.txt_S_SRIssdatTo.Text <> "__/__/____" Then
            If Not IsDate(Me.txt_S_SRIssdatTo.Text) Then
        ...
        If Mid(Me.txt_S_SRIssdatFm.Text, 7) > Mid(Me.txt_S_SRIssdatTo.Text, 7) Then
            MsgBox("Sample Request Issue Date: End Date < Start Date (YY)")
            Me.txt_S_SRIssdatFm.Focus()
            Exit Sub
        ElseIf Mid(Me.txt_S_SRIssdatFm.Text, 7) = Mid(Me.txt_S_SRIssdatTo.Text, 7) Then
            If Me.txt_S_SRIssdatFm.Text.Substring(0, 2) > Me.txt_S_SRIssdatTo.Text.Substring(0, 2) Then
                MsgBox("Sample Request Issue Date: End Date < Start Date (MM)")
                Me.txt_S_SRIssdatFm.Focus()
                Exit Sub
            ElseIf Me.txt_S_SRIssdatFm.Text.Substring(0, 2) = Me.txt_S_SRIssdatTo.Text.Substring(0, 2) Then
                If Me.txt_S_SRIssdatFm.Text.Substring(3, 2) > Me.txt_S_SRIssdatTo.Text.Substring(3, 2) Then
        ...
        Else
            SRISSDATFM = Me.txt_S_SRIssdatFm.Text
        End If

        If Me.txt_S_SRIssdatTo.Text = "__/__/____" Then
            SRISSDATTO = "01/01/1900"
        Else
            SRISSDATTO = Me.txt_S_SRIssdatTo.Text
        End If



        If Me.txt_S_SRRvsdatFm.Text <> "__/__/____" Then
            If Not IsDate(Me.txt_S_SRRvsdatFm.Text) Then
        ...
        If Me.txt_S_SRRvsdatTo.Text <> "__/__/____" Then
            If Not IsDate(Me.txt_S_SRRvsdatTo.Text) Then
        ...
        If Mid(Me.txt_S_SRRvsdatFm.Text, 7) > Mid(Me.txt_S_SRRvsdatTo.Text, 7) Then
            MsgBox("Sample Invoice Revised Date: End Date < Start Date (YY)")
            Me.txt_S_SRRvsdatFm.Focus()
            Exit Sub
        ElseIf Mid(Me.txt_S_SRRvsdatFm.Text, 7) = Mid(Me.txt_S_SRRvsdatTo.Text, 7) Then
            If Me.txt_S_SRRvsdatFm.Text.Substring(0, 2) > Me.txt_S_SRRvsdatTo.Text.Substring(0, 2) Then
                MsgBox("Sample Invoice Revised Date: End Date < Start Date (MM)")
                Me.txt_S_SRRvsdatFm.Focus()
                Exit Sub
            ElseIf Me.txt_S_SRRvsdatFm.Text.Substring(0, 2) = Me.txt_S_SRRvsdatTo.Text.Substring(0, 2) Then
                If Me.txt_S_SRRvsdatFm.Text.Substring(3, 2) > Me.txt_S_SRRvsdatTo.Text.Substring(3, 2) Then
        ...
        Else
            SRRVSDATFM = Me.txt_S_SRRvsdatFm.Text
        End If

        If Me.txt_S_SRRvsdatTo.Text = "__/__/____" Then
            SRRVSDATTO = "01/01/1900"
        Else
            SRRVSDATTO = Me.txt_S_SRRvsdatTo.Text
        End If
