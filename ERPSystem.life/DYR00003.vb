...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(DYR00003))
        ...
        'Label15
        '
        Me.Label15.Location = New System.Drawing.Point(577, 162)
        ...
        'Label16
        '
        Me.Label16.Location = New System.Drawing.Point(294, 162)
        ...
        'txt_S_CredatFm
        '
        Me.txt_S_CredatFm.Location = New System.Drawing.Point(200, 160)
        ...
        Me.ClientSize = New System.Drawing.Size(714, 257)
        ...
        Me.Name = "DYR00003"
        Me.Text = "DYR00003 - Dynamic Report vw_ItemMaster (DYR03)"
...
#End Region
    ...
    Public rs_DYR00003 As New DataSet
    ...
    Private Sub DYR00003_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        gspStr = "sp_select_SYMUSRCO '','" & gsUsrID & "'"
        rtnLong = execute_SQLStatement(gspStr, rs_SYMUSRCO, rtnStr)
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading DYR00003 #001 sp_select_SYMUSRCO : " & rtnStr)
        Else
            Dim i As Integer
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading DYR00003 #002 sp_list_DYR00003 : " & rtnStr)
        Else
