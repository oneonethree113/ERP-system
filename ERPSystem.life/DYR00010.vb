...
#End Region
    ...
    Public rs_DYR00010 As New DataSet
    ...
    Private Sub DYR00010_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        gspStr = "sp_select_SYMUSRCO '','" & gsUsrID & "'"
        rtnLong = execute_SQLStatement(gspStr, rs_SYMUSRCO, rtnStr)
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading DYR00010 #001 sp_select_SYMUSRCO : " & rtnStr)
        Else
            Dim i As Integer
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        Dim SHINVDATFM As String
        Dim SHINVDATTO As String
        ...
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading DYR00010 #002 sp_list_DYR00010 : " & rtnStr)
        Else
