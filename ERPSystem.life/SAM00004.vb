Public Class SAM00004
    ...
    Private Sub Display_Detail(ByVal grd As DataGridView)
        ...
        With grd
            ...
            .Columns(5).HeaderCell.Value = "Vendor Item"
            ...
            .Columns(11).HeaderCell.Value = "Total Qty"
            .Columns(11).ReadOnly = True
            '.Columns(8).Width = 1000
            .Columns(11).Width = 100

            .Columns(12).HeaderCell.Value = "UM"
            .Columns(12).ReadOnly = True
            '.Columns(9).Width = 800
            .Columns(12).Width = 80

            .Columns(13).HeaderCell.Value = "Quotation No."
            ...
            .Columns(23).HeaderCell.Value = "Prc CCY"
            ...
            .Columns(67).HeaderCell.Value = "Pri Customer No."
            .Columns(67).ReadOnly = True
            '.Columns(64).Width = 1500
            .Columns(68).HeaderCell.Value = "Sec Customer No."
            .Columns(68).ReadOnly = True
            '.Columns(65).Width = 1500
            .Columns(69).HeaderCell.Value = "HK Prc Term"
            .Columns(69).ReadOnly = True
            '.Columns(66).Width = 1500
            .Columns(70).HeaderCell.Value = "Fty Prc Term"
            .Columns(70).ReadOnly = True
            '.Columns(67).Width = 1500
            .Columns(71).HeaderCell.Value = "Tran Prc Term"
            .Columns(71).ReadOnly = True
            '.Columns(68).Width = 1500
            .Columns(72).HeaderCell.Value = "Eff Date"
            .Columns(72).ReadOnly = True
            '.Columns(69).Width = 1500
            .Columns(73).HeaderCell.Value = "Exp Date"
            .Columns(73).ReadOnly = True
            .Columns(73).DefaultCellStyle.Format = "MM/dd/yyyy"
