Public Class SYS00002
            ...
            Else
                ...
                Else
                    ...
                    Else
                        ...
                        cboMenuBarStyle.SelectedIndex = -1
                ...
                End If
            End If '
            Dim notInitial As Boolean
            notInitial = (sender Is Nothing) 'In this form, the load function will be call by some operation, not only during opening the module. (I am sorry for my english. I hope you can understand)
            If notInitial Then
            Else
                Call Formstartup(Me.Name) 'set the position to left upper corner.
            End If
        Finally
    ...
    Private Sub setStatus(ByVal mode As String)
        ...
        'Allow changing password but have no other rights
        If Enq_right = False Then
            mmdSave.Enabled = True
            mmdClear.Enabled = False
            mmdFind.Enabled = False
            mmdSearch.Enabled = False
    ...
    Private Sub DataGrid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGrid.CellClick
        ...
        If Not e.RowIndex = -1 And Enq_right_local Then
    ...
    Private Sub DataGrid_CellValidating(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellValidatingEventArgs) Handles DataGrid.CellValidating
        ...
        If row.Cells(e.ColumnIndex).IsInEditMode Then
            If e.ColumnIndex = 2 Then
                If row.Cells("yuc_cocde").Value.ToString = "" Then
                    Exit Sub
                ElseIf Not chkGrdCellValue(row.Cells("yuc_cocde"), "String", 6) Then
                    e.Cancel = True
                Else
            ...
            If e.ColumnIndex = 4 Then
                If row.Cells("yuc_usrgrp").Value.ToString = "" Then
                    Exit Sub
            ...
            If e.ColumnIndex = 5 Then
                If row.Cells("yuc_supid").Value.ToString = "" Then
                    Exit Sub
    ...
    Private Sub txtUsrID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtUsrID.KeyPress
        If e.KeyChar.Equals(Chr(13)) And mmdFind.Enabled = True Then
            Call cmdFind_Click(sender, e)
        End If
    End Sub
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mmdFind.Click
        ...
        Else
            ...
            Else
                ...
                cboMenuBarStyle.SelectedIndex = dtr(0).Item("yup_displaymode") - 1
        ...
        If Not dtr Is Nothing Then
            ...
            If Enq_right_local And dtr.Length > 0 Then
                txtMailAd.Enabled = True
                txtUsrNam.Enabled = True
                txtExpDat.Enabled = True
                txtAccExp.Enabled = True
                txtMailAd.Enabled = True
            End If
        End If
    ...
    Private Sub cmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mmdSave.Click
        If checkFocus(Me) Then Exit Sub
        Dim dtr() As DataRow
                ...
                Else
                    ...
                    If Add_flag Then
                        ...
                        gspStr = "sp_insert_SYUSRPRF_1 '" & gsCompany & "','" & _
                                    ...
                                    gsUsrID & "','" & _
                                    (cboMenuBarStyle.SelectedIndex + 1) & "','" & _
                            ...
                            If dr.RowState = DataRowState.Added And Not dr.Item("yuc_status") = "Y" Then
                                If dr.Item("yuc_creusr").ToString.Trim = "" Then
                                    gspStr = "sp_insert_SYMUSRCO '" & gsCompany & "','" & _
                                                dr.Item("yuc_cocde").ToString.Trim.Replace("'", "''") & "','" & _
                                                dr.Item("yuc_usrid").ToString.Trim.Replace("'", "''") & "','" & _
                                                dr.Item("yco_shtnam").ToString.Trim.Replace("'", "''") & "','" & _
                                                dr.Item("yuc_usrgrp").ToString.Trim.Replace("'", "''") & "'," & _
                                                dr.Item("yuc_usrank") & ",'" & _
                                                dr.Item("yuc_supid").ToString.Trim.Replace("'", "''") & "','" & _
                                                dr.Item("yuc_rmk").ToString.Trim.Replace("'", "''") & "','" & _
